...
<body>
    @if ($request->radiobinus == 'binusian')
    <div class="content">
        <div class="regis-top">
          ...
          <form action="/create-leader-binusian" method="post" enctype="multipart/form-data">
            ...
            <div id="fileInputs">
              ...
              <div class="file-container">
                ...
                <button type="button" class="file-btn" onclick="triggerFileInput1()" id="btn-flazz">Select File <img src="{{Storage::url('images/Upload.svg')}}" alt=""></button>
              </div>
