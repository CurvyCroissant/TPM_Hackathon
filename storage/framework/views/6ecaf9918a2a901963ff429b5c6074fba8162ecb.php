...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/regisNonBinusian.css')); ?>">
...
<body>
    <?php if($request->radiobinus == 'binusian'): ?>
    <div class="content">
        <div class="regis-top">
          <img src="<?php echo e(Storage::url('images/Logo.svg')); ?>" alt="">
          <h2>Leader<br>Registration Binusian</h2>
        </div>
          ...
          <form action="/create-leader-binusian" method="post" enctype="multipart/form-data">
            ...
            <div id="fileInputs">
              ...
              <div class="file-container">
                ...
                <button type="button" class="file-btn" onclick="triggerFileInput1()" id="btn-flazz">Select File <img src="<?php echo e(Storage::url('images/Upload.svg')); ?>" alt=""></button>
              </div>
    ...
    <div class="content">
        <div class="regis-top">
          <img src="<?php echo e(Storage::url('images/Logo.svg')); ?>" alt="">
          <h2>Leader<br>Registration Non Binusian</h2>
        </div>
        <div class="regis-bottom">
            ...
            <div id="fileInputs">
              ...
              <div class="file-container">
                ...
                <button type="button" class="file-btn" onclick="triggerFileInput2()" id="btn-ID">Select File <img src="<?php echo e(Storage::url('images/Upload.svg')); ?>" alt=""></button>
              </div>
              <!-- <p id="error-flazz" class="error-message"></p> -->
              <h5>File format should be in PDF, JPG, JPEG or PNG</h5>
...
<?php /**PATH C:\Louis Storage\Code\Project\Web project\TPM_Hackathon\resources\views/registUser.blade.php ENDPATH**/ ?>