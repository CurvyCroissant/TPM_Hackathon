...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('css/adminPanel.css')); ?>">
...
<body>
  <div class="navbar">
    <img src="<?php echo e(Storage::url('images/Variant3.svg')); ?>" alt="">
    <div>
    ...
    <div class="content-bottom">
      <div class="fitur">
        <div class="search-fitur">
          <img src="<?php echo e(Storage::url('images/Vector (1).svg')); ?>" alt="">
          <input type="search" placeholder="Search Team">
        </div>
        <span class="sort-con">
          <div class="sort">
            <div>
              <img src="<?php echo e(Storage::url('images/basil_sort-outline.svg')); ?>" alt="">
              <span>Sort</span>
            </div>
            <button onclick="choice()" id="sort-btn">
              <img src="<?php echo e(Storage::url('images/ep_arrow-down-bold.svg')); ?>" alt="">
            </button>
          </div>
          <div id="sort-choice">
            <hr>
            <div class="sortA ascending">
              <button>
                <img src="<?php echo e(Storage::url('images/icons8_alphabetical-sorting.svg')); ?>" alt="">
                Ascending
              </button>
            </div>
            <hr>
            <div class="sortA descending">
              <button>
                <img src="<?php echo e(Storage::url('images/icons8_alphabetical-sorting-2.svg')); ?>" alt="">
                Descending
              </button>
            </div>
            <hr>
            <div class="sortA free">
              <button>
                <img src="<?php echo e(Storage::url('images/ic_round-sort.svg')); ?>" alt="">
                Free
              </button>
            </div>
          </div>
      ...
      <?php $__empty_1 = true; $__currentLoopData = $list_group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <div class="team-info">
        <div class="info-general">
          ...
          <span class="info-right">
            <button class="view-data" onclick="viewData1()">
              <img src="<?php echo e(Storage::url('images/fluent-mdl2_view.svg')); ?>" alt="">
              <span>View Data</span>
            </button>
            ...
            <?php $__empty_2 = true; $__currentLoopData = $list_group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
            ...
            <div class="file-container">
              <div class="file">
                ...
                <button class="btn-file">
                  <img src="<?php echo e(Storage::url('images/material-symbols_download.svg')); ?>" alt="">
      ...
      <h4>No Group Has Been Inputed</h4>
      <?php endif; ?>
...
<?php /**PATH C:\Louis Storage\Code\Project\Web project\TPM_Hackathon\resources\views/adminPanel.blade.php ENDPATH**/ ?>